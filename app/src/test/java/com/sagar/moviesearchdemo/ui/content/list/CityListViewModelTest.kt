...
import com.sagar.moviesearchdemo.ui.content.list.CityListUiAction
import com.sagar.moviesearchdemo.ui.content.list.CityListViewModel
import com.sagar.moviesearchdemo.ui.content.list.CityListViewModel.CityListUiEvent
import io.mockk.*
...
class CityListViewModelTest {
    ...
    fun `getEventFlow emits city selected event`() = runTest {
        viewModel.eventFlow.test {
            ...
            assertEquals(CityListUiEvent.OnCitySelected("London"), awaitItem())
            cancelAndIgnoreRemainingEvents()
        }
    }
    ...
    fun `onAction OnCitySelected sends event`() = runTest {
        viewModel.eventFlow.test {
            ...
            assertEquals(CityListUiEvent.OnCitySelected("Chennai"), awaitItem())
            cancelAndIgnoreRemainingEvents()
        }
    }
}
